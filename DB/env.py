...
from infrastructure.persistence.models.application import ApplicationModel
from infrastructure.persistence.models.linkedin_credentials import LinkedInCredentialsModel
